...
with open("provider.yaml", "r") as spec_file:
...
json_data = json.loads(open("provider.json", "r").read())
provider = create_python_object(response_schema["items"], "provider", json_data)
